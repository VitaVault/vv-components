...
export const FormRenderingProps: FormbuilderProps = {
  form: mockForm('FormRendering', [
    mockInput('firstname'),
    mockSelect('vaccines'),
...
export const FormValidationProps: FormbuilderProps = {
  form: mockForm('FormValidation', [
    mockFieldset('data', {
      alignment: 'Vertical',
      fields: [
        mockFieldset('personal', {
...
export const FormRuleExecutionProps: FormbuilderProps = {
  form: mockForm(
    'FormRuleExecution',
    [
